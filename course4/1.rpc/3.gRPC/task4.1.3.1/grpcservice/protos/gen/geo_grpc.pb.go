...
const (
	GeoService_SearchAnswer_FullMethodName  = "/geo_service.GeoService/SearchAnswer"
	GeoService_GeoCodeAnswer_FullMethodName = "/geo_service.GeoService/GeoCodeAnswer"
)
...
type GeoServiceClient interface {
	SearchAnswer(ctx context.Context, in *RequestAddressSearch, opts ...grpc.CallOption) (*ResponseAddress, error)
...
func (c *geoServiceClient) SearchAnswer(ctx context.Context, in *RequestAddressSearch, opts ...grpc.CallOption) (*ResponseAddress, error) {
...
type GeoServiceServer interface {
	SearchAnswer(context.Context, *RequestAddressSearch) (*ResponseAddress, error)
...
func (UnimplementedGeoServiceServer) SearchAnswer(context.Context, *RequestAddressSearch) (*ResponseAddress, error) {
...
func _GeoService_SearchAnswer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GeoServiceServer).SearchAnswer(ctx, req.(*RequestAddressSearch))
	}
...
var GeoService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "geo_service.GeoService",
