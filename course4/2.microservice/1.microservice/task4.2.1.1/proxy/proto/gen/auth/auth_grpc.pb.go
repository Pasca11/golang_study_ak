...
const (
	Auth_Login_FullMethodName         = "/geo_service.Auth/Login"
	Auth_Register_FullMethodName      = "/geo_service.Auth/Register"
	Auth_ValidateToken_FullMethodName = "/geo_service.Auth/ValidateToken"
)
...
func (c *authClient) Register(ctx context.Context, in *User, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
...
func (UnimplementedAuthServer) Register(context.Context, *User) (*User, error) {
